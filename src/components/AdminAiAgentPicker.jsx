...
export const TITAN_MODELS = [
  ...
  },
  {
    ...
    desc: 'High-speed multimodal intelligence with real-time database queries, GMV analysis, and C-suite briefs.',
    icon: Zap,
    color: '#10b981',
    bgColor: '#ecfdf5',
    latency: '~350ms',
  ...
  },
  {
    ...
    desc: 'Ultra-low latency LPU inference with native function calling for high-speed platform intelligence.',
    icon: Cpu,
    color: '#f97316',
    bgColor: '#fff7ed',
    latency: '~180ms',
  ...
  },
  {
    ...
    desc: 'Wafer-scale high-throughput inference engine delivering instantaneous anomaly & risk detection.',
    icon: Layers,
    color: '#8b5cf6',
    bgColor: '#f5f3ff',
    latency: '~150ms',
...
export const TITAN_AGENTS = TITAN_MODELS;

export default function AdminAiAgentPicker({ activeAgentId, onSelectAgent, onBack }) {
  return (
      ...
      <div className="titan-ai-subpanel-header">
        <div className="titan-ai-subpanel-header-left">
          ...
          <div>
            ...
            <p>Select the reasoning engine used by Titan Platform Intelligence</p>
          </div>
        </div>
      </div>

      <div className="titan-ai-subpanel-body">
        <div className="model-picker-banner">
          <ShieldCheck size={16} className="model-picker-banner-icon" />
          <span>
            All AI engines can perform all platform analytics tasks (GMV, merchant audits, stockout risks, C-suite briefs). Switch models anytime based on cloud preference.
          </span>
        </div>

        <div className="model-cards-grid">
          {TITAN_MODELS.map((model) => {
